...
export const TiktokLogo = ({ className = '' }: { className?: string }) => {
  return (
    <>
      <Image src={'/logos/logo_black.png'} alt="TikTok_Logo" width={200} height={200} className={cn(className, 'dark:block hidden')} />
      <Image src={'/logos/logo_black.png'} alt="TikTok_Logo" width={200} height={200} className={cn(className, 'block dark:hidden')} />
    </>
  )
}
...
export const FeatherIcon = ({ size = 28, className }: { size?: number; className?: string }) => {
  return (
    <svg fillRule="evenodd" clipRule="evenodd" className={cn('fill-current', className)} style={{ color: 'currentcolor' }} viewBox="0 0 24 24" aria-hidden="true" width={size} height={size}>
      <g>
...
export const EmptyTree = ({ className }: { className?: string }) => {
  return (
    <svg fill="none" width="64" viewBox="0 0 24 24" height="64" style={{ color: 'currentcolor' }} className={className}>
      <path fill="currentColor" fillRule="evenodd" clipRule="evenodd" d="M3 4a1 1 0 0 1 1-1h1a8.003 8.003 0 0 1 7.75 6.006A7.985 7.985 0 0 1 19 6h1a1 1 0 0 1 1 1v1a8 8 0 0 1-8 8v4a1 1 0 1 1-2 0v-7a8 8 0 0 1-8-8V4Zm2 1a6 6 0 0 1 6 6 6 6 0 0 1-6-6Zm8 9a6 6 0 0 1 6-6 6 6 0 0 1-6 6Z"></path>
    </svg>
  )
}
...
export const CameraIcon = ({ size = 14, className }: { size?: number; className?: string }) => {
  return (
    <svg fill="none" height={size} width={size} viewBox="0 0 24 24" style={{ color: 'currentcolor' }}>
      <path fill="currentColor" fillRule="evenodd" clipRule="evenodd" d="M8.371 3.89A2 2 0 0 1 10.035 3h3.93a2 2 0 0 1 1.664.89L17.035 6H20a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h2.965L8.37 3.89ZM12 9a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7Z"></path>
    </svg>
  )
}
...
export const ArrowLeftIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg fill="none" width={size} viewBox="0 0 24 24" height={size} style={{ color: 'currentcolor' }}>
...
export const SparklesIcon = ({ size = 16 }: { size?: number }) => (
  <svg height={size} strokeLinejoin="round" viewBox="0 0 16 16" width={size} style={{ color: 'currentcolor' }}>
    <path d="M2.5 0.5V0H3.5V0.5C3.5 1.60457 4.39543 2.5 5.5 2.5H6V3V3.5H5.5C4.39543 3.5 3.5 4.39543 3.5 5.5V6H3H2.5V5.5C2.5 4.39543 1.60457 3.5 0.5 3.5H0V3V2.5H0.5C1.60457 2.5 2.5 1.60457 2.5 0.5Z" fill="currentColor" />
...
export const ImageIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg fill="none" viewBox="0 0 24 24" width={size} height={size} style={{ color: 'currentcolor' }}>
      <path fill="hsl(211, 99%, 56%)" fillRule="evenodd" clipRule="evenodd" d="M3 4a1 1 0 0 1 1-1h16a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V4Zm2 1v7.213l1.246-.932.044-.03a3 3 0 0 1 3.863.454c1.468 1.58 2.941 2.749 4.847 2.749 1.703 0 2.855-.555 4-1.618V5H5Zm14 10.357c-1.112.697-2.386 1.097-4 1.097-2.81 0-4.796-1.755-6.313-3.388a1 1 0 0 0-1.269-.164L5 14.712V19h14v-3.643ZM15 8a1 1 0 1 0 0 2 1 1 0 0 0 0-2Zm-3 1a3 3 0 1 1 6 0 3 3 0 0 1-6 0Z"></path>
    </svg>
  )
}
...
export const HomeIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg fill="none" width={size} viewBox="0 0 24 24" height={size} aria-hidden="true" style={{ color: 'currentcolor' }}>
      <path fill="currentColor" fillRule="evenodd" clipRule="evenodd" d="M11.37 1.724a1 1 0 0 1 1.26 0l8 6.5A1 1 0 0 1 21 9v11a1 1 0 0 1-1 1h-6a1 1 0 0 1-1-1v-5h-2v5a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V9a1 1 0 0 1 .37-.776l8-6.5ZM5 9.476V19h4v-5a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v5h4V9.476l-7-5.688-7 5.688Z"></path>
    </svg>
  )
}
...
export const HomeFilledIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg fill="none" width={size} viewBox="0 0 24 24" height={size} aria-hidden="true">
      <path fill="currentColor" fillRule="evenodd" clipRule="evenodd" d="M12.63 1.724a1 1 0 0 0-1.26 0l-8 6.5A1 1 0 0 0 3 9v11a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1v-6h4v6a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1V9a1 1 0 0 0-.37-.776l-8-6.5Z"></path>
    </svg>
  )
}
...
export const ExploreFilledIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg aria-label="탐색 탭" fill="currentColor" height={size} role="img" viewBox="0 0 24 24" width={size} style={{ color: 'currentcolor' }}>
      <title>탐색 탭</title>
...
export const UserFilledIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg fill="none" width={size} viewBox="0 0 24 24" height={size} aria-hidden="true" style={{ color: 'currentcolor' }}>
      <path fill="currentColor" fillRule="evenodd" clipRule="evenodd" d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10Zm3-12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm-3 10a7.976 7.976 0 0 1-5.714-2.4C7.618 16.004 9.605 15 12 15c2.396 0 4.383 1.005 5.714 2.6A7.976 7.976 0 0 1 12 20Z"></path>
    </svg>
  )
}
...
export const SettingIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-settings-icon lucide-settings">
...
export const SearchIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-search-icon lucide-search">
...
export const BellIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-bell-icon lucide-bell">
...
export const BellFilledIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg fill="none" width={size} viewBox="0 0 24 24" height={size} aria-hidden="true" style={{ color: 'currentcolor' }}>
      <path fill="currentColor" fillRule="evenodd" clipRule="evenodd" d="M12 2a7.853 7.853 0 0 0-7.784 6.815l-1.207 9.053A1 1 0 0 0 4 19h3.354c.904 1.748 2.607 3 4.646 3 2.039 0 3.742-1.252 4.646-3H20a1 1 0 0 0 .991-1.132l-1.207-9.053A7.853 7.853 0 0 0 12 2Zm2.222 17H9.778c.61.637 1.399 1 2.222 1s1.613-.363 2.222-1Z"></path>
    </svg>
  )
}
...
export const ChatIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-message-circle-more-icon lucide-message-circle-more">
...
export const ChatFilledIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg fill="none" width={size} viewBox="0 0 24 24" height={size} aria-hidden="true" style={{ color: 'currentcolor' }}>
      <path fill="currentColor" fillRule="evenodd" clipRule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10a9.968 9.968 0 0 1-4.136-.893l-4.68.876a1 1 0 0 1-1.164-1.184l.931-4.537A9.965 9.965 0 0 1 2 12Zm4.25 0a1.25 1.25 0 1 0 2.5 0 1.25 1.25 0 0 0-2.5 0Zm4.5 0a1.25 1.25 0 1 0 2.5 0 1.25 1.25 0 0 0-2.5 0Zm5.75 1.25a1.25 1.25 0 1 1 0-2.5 1.25 1.25 0 0 1 0 2.5Z"></path>
    </svg>
  )
}
...
export const HeartIcon = ({ size = 16, className = '' }: { className?: string; size?: number }) => {
  return (
    <svg fill="none" width={size} viewBox="0 0 24 24" height={size} style={{ color: 'currentcolor' }} className={className}>
...
export const HeartFillIcon = ({ size = 16, className = '' }: { className?: string; size?: number }) => {
  return (
...
export const MoreIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-ellipsis-vertical-icon lucide-ellipsis-vertical">
...
export const StarIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg width={size} height={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" style={{ color: 'currentcolor' }}>
...
export const PhoneIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" className="size-">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
export const EmailIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" className="size-">
      <path d="M20.3721 18.3988V6.60107H3.62793V18.3988H20.3721Z" stroke="currentColor" strokeWidth="1.5" />
      <path d="M3.78369 6.75134L11.0071 13.7586C11.5425 14.2751 12.5168 14.269 13.0409 13.7633L20.2593 6.80774" stroke="currentColor" strokeWidth="1.5" />
...
export const SendIcon = ({ size = 24 }: { size?: number }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-arrow-up-icon lucide-arrow-up">
...
export const CertIcon = ({ size = 18, className = '' }: { size?: number; className?: string }) => {
  return (
    <svg fill="rgb(0, 149, 246)" height={size} role="img" viewBox="0 0 40 40" width={size} className={className}>
      <title>인증됨</title>
...
export const DoorOutIcon = ({ size = 28 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ color: 'currentcolor' }}>
    ...
    <path d="M17 18L20.7879 14.2121C20.905 14.095 20.905 13.905 20.7879 13.7879L17 10" stroke="currentColor" strokeWidth="2" strokeLinecap="round"></path>
  </svg>
)
