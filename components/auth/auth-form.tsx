        ...
        <div className="auth-split-container">
            <div className="auth-visual-side">
                <div className="auth-visual-bg">
                    <Image src="/default-placeholder.png" alt="AI Health Technology" fill className="object-cover opacity-30" />
                </div>
                ...
                <div className="auth-visual-content">
                    <div className="mb-8">
                        ...
                        <p className="text-xl text-white/80 text-pretty">개인 맞춤형 AI 건강 솔루션으로 더 나은 삶을 시작하세요</p>
                    </div>
                                ...
                                <CardContent className="px-0">
                                    <form onSubmit={handleLogin} className="space-y-6">
                                        <div className="space-y-2">
                                            ...
                                            {!errors.email && loginData.email && validateEmail(loginData.email) === null && (
                                                <SuccessIndicator />
                                            )}
                                        </div>
                                        <div className="space-y-2">
                                        ...
                                        <Button type="submit" className="w-full auth-button-modern" disabled={isLoading}>
                                            {isLoading ? "로그인 중..." : "로그인"}
                                        </Button>
                                    </form>
                                </CardContent>
                                ...
                                <CardContent className="px-0">
                                    <form onSubmit={handleSignup} className="space-y-4">
                                        <div className="space-y-2">
                                            ...
                                            {!errors.name && signupData.name && validateName(signupData.name) === null && (
                                                <SuccessIndicator />
                                            )}
                                        </div>
                                        <div className="space-y-2">
                                            ...
                                            />
                                            {errors.email && <ErrorMessage error={errors.email} />}
                                            {!errors.email && signupData.email && validateEmail(signupData.email) === null && (
                                                <SuccessIndicator />
                                            )}
                                        </div>
                                        <div className="space-y-2">
                                            ...
                                            {errors.password && <ErrorMessage error={errors.password} />}
                                            {!errors.password && signupData.password && validatePassword(signupData.password) === null && (
                                                <SuccessIndicator />
                                            )}
                                        </div>
                                        <div className="space-y-2">
