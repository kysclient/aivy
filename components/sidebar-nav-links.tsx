      ...
      {navLinks.map((link) => {
        ...
        return (
          <Link
            ...
            key={link.href}
            className={cn(
              'w-full text-sm sm:text-lg flex text-foreground font-medium flex-row items-center px-[10px] py-[8px] sm:py-[12px] rounded-[8px] hover:bg-muted gap-[8px]',
              isActive && 'font-bold'
            )}
