  ...
  return (
    <div className="relative">
      {metadata.length > 0 && (
        <div
          className={cn(
            'my-2 grid gap-0.5 border border-border rounded-[12px] overflow-hidden max-w-4xl mx-auto',
            {
          ...
          {metadata.map((item, idx) => (
            <div
              ...
              className={cn(
                ...
                metadata.length === 3 && idx === 0 && 'row-span-2',
                metadata.length === 3 && idx > 0 && 'row-span-1'
              )}
              style={{
      ...
      <ImageCarouselModal
        images={metadata.map((item) => item.url)}
        isOpen={isOpen}
