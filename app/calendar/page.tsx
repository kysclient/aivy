...
export default function Home() {
    ...
    const calculateEventStyle = (startTime: any, endTime: any) => {
        ...
        <div className="relative min-h-screen w-full overflow-hidden">
            ...
            >
                <div className="flex items-center gap-4">
                    ...
                    <span className="text-2xl font-semibold text-white drop-shadow-lg">Aivy</span>
                </div>
            ...
            <main className="relative h-screen w-full pt-20 flex">
                {/* Sidebar */}
                <div
                    className={`hidden sm:flex w-64 h-full bg-white/10 backdrop-blur-lg p-4 shadow-xl border-r border-white/20 rounded-tr-3xl  animate-fadeIn flex-col justify-between`}
                        ...
                        <div className="mb-6">
                            ...
                            <div className="grid grid-cols-7 gap-1 text-center">
                                ...
                                {miniCalendarDays.map((day, i) => (
                                    <div
                                        key={i}
                                        className={`text-xs rounded-full w-7 h-7 flex items-center justify-center ${day === 5 ? "bg-blue-500 text-white" : "text-white hover:bg-white/20"
                                            } ${!day ? "invisible" : ""}`}
                                    >
                                        {day}
                                    </div>
