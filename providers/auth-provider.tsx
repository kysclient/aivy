...
import { AuthResponse, CreateUserDto, LoginDto, UpdateUserDto, UserRepository } from '@/repositoires/UserRepository'
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
    ...
    // Login function
    const login = useCallback(async (credentials: LoginDto, rememberMe: boolean = false) => {
        setIsLoading(true)
        setError(null)
        ...
        try {
            ...
            TokenManager.setTokens(response.tokens.accessToken, response.tokens.refreshToken, rememberMe)
